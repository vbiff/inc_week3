...
let DeleteAllDevicesHandler = class DeleteAllDevicesHandler {
    constructor(deviceRepository) {
        this.deviceRepository = deviceRepository;
        this.deleteAllDevicesHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield this.deviceRepository.deleteAllDevicesExceptCurrent(req.user.id, req.user.deviceId);
            res.sendStatus(http_statuses_1.HttpStatuses.NO_CONTENT_204);
        });
    }
};
exports.DeleteAllDevicesHandler = DeleteAllDevicesHandler;
exports.DeleteAllDevicesHandler = DeleteAllDevicesHandler = __decorate([
