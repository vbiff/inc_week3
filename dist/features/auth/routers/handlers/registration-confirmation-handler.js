...
exports.RegistrationConfirmationHandler = void 0;
...
let RegistrationConfirmationHandler = class RegistrationConfirmationHandler {
    constructor(authService) {
        this.authService = authService;
        this.registrationConfirmationHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const code = req.body.code;
            const result = yield this.authService.confirmRegistration(code);
...
exports.RegistrationConfirmationHandler = RegistrationConfirmationHandler = __decorate([
