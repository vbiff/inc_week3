...
let NewPasswordHandler = class NewPasswordHandler {
    constructor(authService) {
        ...
        this.newPasswordHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.authService.newPassword(req.body.recoveryCode, req.body.newPassword);
