...
let RefreshTokenHandler = class RefreshTokenHandler {
    constructor(authService) {
        ...
        this.refreshTokenHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const currentRefreshToken = req.cookies.refreshToken;
                const userId = req.user.id;
                const refreshTokensResult = yield this.authService.refreshTokens(currentRefreshToken, userId, req.user.deviceId);
                if (refreshTokensResult.status !== resultCode_1.ResultStatus.Success) {
