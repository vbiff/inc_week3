...
let CommentService = class CommentService {
    ...
    createComment(inputDto, postId, userInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            const newComment = Object.assign(Object.assign({}, inputDto), { postId: postId, commentatorInfo: {
    ...
    deleteComment(commentId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.commentsRepository.deleteCommentById(commentId, userId);
        });
    }
    updateComment(commentId, content, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.commentsRepository.updateCommentById(commentId, userId, {
                content: content,
            });
        });
    }
