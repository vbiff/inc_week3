...
const comment_like_status_validation_1 = require("../validation/comment-like-status-validation");
...
exports.commentsRouter.get("/:id", optional_access_token_guard_1.optionalAccessTokenGuardMiddleware, getCommentByIdHandler.getCommentByIdHandler);
...
exports.commentsRouter.put("/:commentId/like-status", access_token_guard_1.accessTokenGuardMiddleware, comment_like_status_validation_1.commentLikeStatusValidation, 
// mongoCommentIdValidation,
// commentInputDtoValidation,
validation_result_middleware_1.validationResultMiddleware, setCommentLike.setLikeForCommentByIdHandler);
