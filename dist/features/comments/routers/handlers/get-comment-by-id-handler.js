...
let GetCommentByIdHandler = class GetCommentByIdHandler {
    constructor(commentsQueryRepository) {
        ...
        this.getCommentByIdHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            res.status(http_statuses_1.HttpStatuses.OK_200).send(comment);
        });
    }
};
exports.GetCommentByIdHandler = GetCommentByIdHandler;
exports.GetCommentByIdHandler = GetCommentByIdHandler = __decorate([
