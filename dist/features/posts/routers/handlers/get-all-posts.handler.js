...
let GetAllPostsHandler = class GetAllPostsHandler {
    constructor(postsQueryRepository) {
        this.postsQueryRepository = postsQueryRepository;
        this.getAllPostsHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const queryInput = (0, query_input_dto_helper_1.queryInputDtoHelper)(req);
            const resultPosts = yield this.postsQueryRepository.findAll(queryInput);
            res.send(resultPosts);
        });
    }
};
exports.GetAllPostsHandler = GetAllPostsHandler;
exports.GetAllPostsHandler = GetAllPostsHandler = __decorate([
