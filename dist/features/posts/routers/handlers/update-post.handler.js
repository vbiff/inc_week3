...
let UpdatePostHandler = class UpdatePostHandler {
    constructor(postsService) {
        this.postsService = postsService;
        this.updatePostHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.postsService.updatePost(req.body, req.params.id);
            if (result === null) {
