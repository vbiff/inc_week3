...
let UpdateBlogHandler = class UpdateBlogHandler {
    constructor(blogsService) {
        ...
        this.updateBlogHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const blog = yield this.blogsService.updateBlog(req.body, req.params.id);
            if (blog === null) {
...
exports.UpdateBlogHandler = UpdateBlogHandler = __decorate([
