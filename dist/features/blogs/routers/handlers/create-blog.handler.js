...
const blogs_services_1 = require("../../application/command-services/blogs-services");
...
let CreateBlogHandler = class CreateBlogHandler {
    constructor(blogsService, blogsQueryRepository) {
        ...
        this.createBlogHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const blogId = yield this.blogsService.createBlog(req.body);
            if (!blogId) {
                return;
            }
            const newBlog = yield this.blogsQueryRepository.findByObjectId(blogId);
            if (!newBlog) {
                return;
            }
            res.status(http_statuses_1.HttpStatuses.CREATED_201).send(newBlog);
        });
    }
};
exports.CreateBlogHandler = CreateBlogHandler;
exports.CreateBlogHandler = CreateBlogHandler = __decorate([
